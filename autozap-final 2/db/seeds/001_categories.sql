...
VALUES
  ...
  ('aksessuary', 'Аксессуары', 70, false, 'Аксессуары | Автозапчасти на Салтыкова-Щедрина', 'Автомобильные аксессуары и сопутствующие товары.'),
  ('ves-assortiment', 'Весь ассортимент', 80, true, 'Весь ассортимент | Автозапчасти на Салтыкова-Щедрина', 'Полный каталог товаров магазина автозапчастей в Талдоме.')
