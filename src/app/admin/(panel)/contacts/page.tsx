  ...
  return (
    <div>
      ...
      <form action={updateContactsAction} className="max-w-3xl rounded-card border border-[#243249] bg-[#101827] p-5">
        ...
        <div className="mt-4 rounded-card border border-[#2563EB]/30 bg-[#2563EB]/10 p-4 text-sm leading-6 text-[#DBEAFE]">
          Живая карта на сайте отображается через Яндекс Карты. Для JS-карты с отметкой задайте
          переменную окружения <span className="font-semibold text-white">YANDEX_MAPS_API_KEY</span>.
          Если ключ не указан, сайт покажет интерактивную встроенную карту по адресу магазина.
        </div>
        <div className="mt-6">
