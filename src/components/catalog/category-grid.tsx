  ...
  return (
    <div className="grid grid-cols-2 gap-3 sm:gap-5 lg:grid-cols-4">
      {categories.map((category, index) => (
        <Link
          key={category.slug}
          href={withCatalogNavigationContext(`/catalog/${category.slug}`, navigationContext)}
        ...
        >
          ...
          <div className="relative z-10 mt-auto">
            <h2 className="text-base font-semibold leading-[1.12] text-white sm:text-[24px] lg:text-[30px]">
              {category.name}
            </h2>
