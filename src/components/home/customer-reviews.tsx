          ...
          <div className="reviews-carousel -mx-4 flex gap-3 overflow-x-auto px-4 pb-2 sm:-mx-6 sm:px-6 lg:mx-0 lg:grid lg:grid-cols-2 lg:overflow-visible lg:px-0 lg:pb-0">
            {reviews.map((review, index) => (
              <article
                ...
                className="scroll-reveal stagger-card flex w-[86vw] max-w-[352px] shrink-0 snap-start flex-col rounded-card border border-white/10 bg-[linear-gradient(145deg,rgba(31,41,55,0.94),rgba(17,24,39,0.98))] p-5 shadow-[0_18px_60px_rgba(0,0,0,0.22)] lg:w-auto lg:max-w-none lg:min-w-0"
              ...
              >
                ...
                <p className="mt-4 flex-1 text-sm leading-6 text-[#E5E7EB] sm:text-base sm:leading-7">
                  {review.text}
                </p>
